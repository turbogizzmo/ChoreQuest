...
from backend.routers._chores_helpers import (
    get_chore_or_404 as _get_chore_or_404,
    reload_chore_with_category as _reload_chore_with_category,
    reload_assignment_with_relations as _reload_assignment_with_relations,
    quest_assigned_notification as _quest_assigned_notification,
    build_rotation_summaries as _build_rotation_summaries,
)
...
# ---------------------------------------------------------------------------
# Helpers — see backend/routers/_chores_helpers.py for implementations
# ---------------------------------------------------------------------------
